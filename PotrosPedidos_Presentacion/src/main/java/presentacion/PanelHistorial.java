...
public class PanelHistorial extends javax.swing.JPanel {
    ...
    public PanelHistorial(FramePrincipal framePrincipal) {
        ...
        try {
            ...
            logger.log(Level.SEVERE, "No jalo el historial");
        }
        setFuentes();
    }
    ...
    private void initComponents() {
        ...
        panelTop.setMaximumSize(new java.awt.Dimension(380, 600));
        panelTop.setMinimumSize(new java.awt.Dimension(380, 600));
        panelTop.setName(""); // NOI18N
        panelTop.setOpaque(false);
        panelTop.setPreferredSize(new java.awt.Dimension(380, 600));
    ...
    public void crearHistorial() throws PersistenciaException {
        ...
        for (int i = 0; i < listaPedidos.size(); i++) {
            ...
            for (int j = 0; j < 3; j++) {
                if (listaPedidos.get(i).getProductos().get(j) == null) {
                    break;
                }
                rutas[j] = listaPedidos.get(i).getProductos().get(j).getDireccionImagen();
            }
            JPanel productoPanel = crearPanelPedido(
                    listaPedidos.get(i).getIdPedido(),
                    listaPedidos.get(i).getNumeroPedido(),
                    listaPedidos.get(i).getClaveRecoleccion(),
                    listaPedidos.get(i).getNumeroProductos(),
                    listaPedidos.get(i).getTotal(),
                    listaPedidos.get(i).getFecha(),
                    rutas);

            Integer identificador = listaPedidos.get(i).getIdPedido();
     ...
     */
    private JPanel crearPanelPedido(Integer identificador, String numero, String claveRecoger, Integer numArticulos, Float total, LocalDate fecha, String[] rutaImagenes) {
...
//            imagenLabels[i].setBackground(Color.YELLOW);
        ...
        JLabel identificadorLabel = new JLabel("Pedido #" + identificador.toString());
        ...
        JLabel numArticulosLabel = new JLabel(numArticulos.toString() + " artículos");
